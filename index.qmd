...
rainette_plot(
  res, dtm,k=6,
  cluster_label=c("relief", "governance","weather",
                  "anticipation","hydrology","damage"),
  colors=c("#e14774","#ffc847","#5f2ad3",
           "#16968d","#6b7edd","#ff4646")
)
```
...
#| fig-cap: "---"
plot_random_forest("curation",remove="mean_views_f3months")
```
...
#| label: fig-views
#| fig-cap: "---"
wp_pages_complete=wp_pages_complete %>% 
  filter(year>=2015)
plot_random_forest("mean_views_f3months")
```
